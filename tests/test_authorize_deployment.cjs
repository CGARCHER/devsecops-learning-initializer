...
const authorize = require(process.env.AUTHORIZE_SCRIPT || '../engine/scripts/authorize_deployment.cjs');
...
const workflow = fs.readFileSync(process.env.AUTHORIZE_WORKFLOW || path.join(__dirname, '../engine/workflows/authorize-main.yml'), 'utf8');
